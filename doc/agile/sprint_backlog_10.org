...
#+CAPTION: Clock summary at [2016-07-08 Fri 15:46]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 10:56   |       |      | 100.0 |
| Active                                                                      |         | 10:56 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:09 |  10.5 |
| STARTED Socialising                                                         |         |       | 0:48 |   7.3 |
| COMPLETED Review the design changes done to geometry                        |         |       | 1:51 |  16.9 |
| COMPLETED Tidy-up neurite                                                   |         |       | 1:19 |  12.0 |
| COMPLETED Code-generate all models and get code to build                    |         |       | 0:25 |   3.8 |
| COMPLETED Create a command-line utility to execute geometry workflow        |         |       | 1:42 |  15.5 |
| STARTED Implement =swc= to =geometry= tree factory                          |         |       | 2:48 |  25.6 |
| STARTED Create a class to generate scad files                               |         |       | 0:07 |   1.1 |
| STARTED Create a polygon mesh with the simple SWC file                      |         |       | 0:47 |   7.2 |
