...
#+CAPTION: Clock summary at [2016-07-11 Mon 17:21]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 13:32   |       |      | 100.0 |
| Active                                                                      |         | 13:32 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:09 |   8.5 |
| STARTED Socialising                                                         |         |       | 0:48 |   5.9 |
| COMPLETED Review the design changes done to geometry                        |         |       | 1:51 |  13.7 |
| COMPLETED Tidy-up neurite                                                   |         |       | 1:19 |   9.7 |
| COMPLETED Code-generate all models and get code to build                    |         |       | 0:25 |   3.1 |
| COMPLETED Create a command-line utility to execute geometry workflow        |         |       | 1:42 |  12.6 |
| STARTED Implement =swc= to =geometry= tree factory                          |         |       | 2:48 |  20.7 |
| STARTED Create a class to generate scad files                               |         |       | 2:43 |  20.1 |
| STARTED Create a polygon mesh with the simple SWC file                      |         |       | 0:47 |   5.8 |
