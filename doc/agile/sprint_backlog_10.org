...
#+CAPTION: Clock summary at [2016-07-06 Wed 18:00]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *9:14* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 9:14   |      |      | 100.0 |
| Active                                                                      |        | 9:14 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 1:09 |  12.5 |
| STARTED Socialising                                                         |        |      | 0:48 |   8.7 |
| COMPLETED Review the design changes done to geometry                        |        |      | 1:51 |  20.0 |
| COMPLETED Tidy-up neurite                                                   |        |      | 1:19 |  14.3 |
| COMPLETED Code-generate all models and get code to build                    |        |      | 0:25 |   4.5 |
| STARTED Implement =swc= to =geometry= tree factory                          |        |      | 2:48 |  30.3 |
| STARTED Create a class to generate scad files                               |        |      | 0:07 |   1.3 |
| STARTED Create a polygon mesh with the simple SWC file                      |        |      | 0:47 |   8.5 |
