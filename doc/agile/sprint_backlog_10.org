...
#+CAPTION: Clock summary at [2016-07-06 Wed 17:33]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *8:50* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 8:50   |      |      | 100.0 |
| Active                                                                      |        | 8:50 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 1:09 |  13.0 |
| STARTED Socialising                                                         |        |      | 0:48 |   9.1 |
| COMPLETED Review the design changes done to geometry                        |        |      | 1:51 |  20.9 |
| COMPLETED Tidy-up neurite                                                   |        |      | 1:19 |  14.9 |
| COMPLETED Code-generate all models and get code to build                    |        |      | 0:25 |   4.7 |
| STARTED Implement =swc= to =geometry= tree factory                          |        |      | 2:31 |  28.5 |
| STARTED Create a polygon mesh with the simple SWC file                      |        |      | 0:47 |   8.9 |
