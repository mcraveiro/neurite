...
#+CAPTION: Clock summary at [2016-07-14 Thu 14:46]
| <75>                                                                        |         |       |      |       |
| Headline                                                                    | Time    |       |      |     % |
|-----------------------------------------------------------------------------+---------+-------+------+-------|
...
| Stories                                                                     | 15:16   |       |      | 100.0 |
| Active                                                                      |         | 15:16 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |         |       | 1:09 |   7.5 |
| STARTED Socialising                                                         |         |       | 0:48 |   5.2 |
| COMPLETED Review the design changes done to geometry                        |         |       | 1:51 |  12.1 |
| COMPLETED Tidy-up neurite                                                   |         |       | 1:19 |   8.6 |
| COMPLETED Code-generate all models and get code to build                    |         |       | 0:25 |   2.7 |
| COMPLETED Create a command-line utility to execute geometry workflow        |         |       | 1:42 |  11.1 |
| STARTED Implement =swc= to =geometry= tree factory                          |         |       | 2:48 |  18.3 |
| STARTED Create a class to generate scad files                               |         |       | 4:27 |  29.1 |
| STARTED Create a polygon mesh with the simple SWC file                      |         |       | 0:47 |   5.1 |
