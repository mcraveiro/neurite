...
#+CAPTION: Clock summary at [2016-01-18 Mon 16:08]
| <75>                                                                        |        |      |      |
| Headline                                                                    | Time   |      |      |
|-----------------------------------------------------------------------------+--------+------+------|
| *Total time*                                                                | *2:16* |      |      |
...
| STARTED Journal club and other activities                                   |        |      | 0:14 |
| STARTED Place geometric object in correct locations in space                |        |      | 1:40 |
#+end:
...
*** STARTED Place geometric object in correct locations in space      :story:
