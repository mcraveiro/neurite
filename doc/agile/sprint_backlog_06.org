...
#+CAPTION: Clock summary at [2016-01-20 Wed 17:09]
| <75>                                                                        |         |       |      |
| Headline                                                                    | Time    |       |      |
|-----------------------------------------------------------------------------+---------+-------+------|
| *Total time*                                                                | *10:44* |       |      |
...
| COMPLETED Design a simple project structure for use cases                   |         |       | 2:21 |
...
*** Create the =geometry= project                                     :story:

We need a very simple project with the basic polyhedra.

*** Create the =geometry.swc= project                                 :story:
...
*** Create a =vtk.geometry= project                                   :story:
