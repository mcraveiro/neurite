...
#+CAPTION: Clock summary at [2016-02-02 Tue 17:45]
| <75>                                                                        |        |      |      |       |
| Headline                                                                    | Time   |      |      |     % |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| *Total time*                                                                | *7:44* |      |      | 100.0 |
|-----------------------------------------------------------------------------+--------+------+------+-------|
| Stories                                                                     | 7:44   |      |      | 100.0 |
| Active                                                                      |        | 7:44 |      | 100.0 |
| STARTED Sprint and product backlog grooming                                 |        |      | 0:27 |   5.8 |
| STARTED Socialising                                                         |        |      | 0:46 |   9.9 |
| STARTED Create a blog post on SWC                                           |        |      | 3:48 |  49.1 |
| Create a docker image to build neurite                                      |        |      | 2:43 |  35.1 |
