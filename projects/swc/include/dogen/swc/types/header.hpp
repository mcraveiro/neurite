#ifndef DOGEN_SWC_TYPES_HEADER_HPP
#define DOGEN_SWC_TYPES_HEADER_HPP
...
#include <string>
#include <algorithm>
#include "dogen/swc/serialization/header_fwd_ser.hpp"
...
template<>
inline void swap(
    dogen::swc::header& lhs,
    dogen::swc::header& rhs) {
    lhs.swap(rhs);
}
