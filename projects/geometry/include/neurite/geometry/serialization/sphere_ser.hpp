 ...
 *
 */
#ifndef NEURITE_GEOMETRY_SERIALIZATION_SPHERE_SER_HPP
#define NEURITE_GEOMETRY_SERIALIZATION_SPHERE_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(neurite::geometry::sphere)
namespace boost {
