 ...
 *
 */
#ifndef NEURITE_GEOMETRY_SERIALIZATION_OPERATION_NODE_SER_HPP
#define NEURITE_GEOMETRY_SERIALIZATION_OPERATION_NODE_SER_HPP
...
BOOST_SERIALIZATION_SPLIT_FREE(neurite::geometry::operation_node)
namespace boost {
