 ...
 *
 */
#ifndef NEURITE_UTILITY_TEST_ASSERTER_HPP
#define NEURITE_UTILITY_TEST_ASSERTER_HPP
...
#include "neurite/utility/test/xml_serialization_helper.hpp"
#include "neurite/utility/test/file_asserter.hpp"
...
private:
    static neurite::utility::log::logger lg_;

public:
    static neurite::utility::log::logger logger() { return lg_; }
