...
#include "neurite/utility/io/set_io.hpp"
#include "neurite/utility/io/vector_io.hpp"
#include "neurite/utility/serialization/xml_helper.hpp"
...
bool compare_paths(
    ...
    auto lg(neurite::utility::test::asserter::logger());
...
neurite::utility::log::logger asserter::lg_(
    neurite::utility::log::logger_factory("utility.test.asserter"));
