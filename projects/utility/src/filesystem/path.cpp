...
#include "neurite/utility/filesystem/path.hpp"
#include "neurite/utility/filesystem/file_not_found.hpp"
...
const boost::filesystem::path in_share_neurite_versioned_dir(
    "../share/neurite-" NEURITE_VERSION);
const boost::filesystem::path in_share_neurite_dir("../share/neurite/data");
